...
const Newsletter = () => {
  return (
      ...
      <div className="container xl:w-[1140px] lg:w-[800px] w-full mx-auto px-5 bg-[url(./assets/images/webp/Newsletter.webp)] bg-cover bg-no-repeat py-14">
        <Heading headingText="Join Our " headingSpanText="Newsletter" className="!max-w-[450px] !mx-auto"/>
          ...
          <CustomButton CustomButton="Submit" myClass='!bg-[#007EA7]' customClass="-mr-5" whiteArrow={true} />
              </div>
          </div>
    </section>
  )
