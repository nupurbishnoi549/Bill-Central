            ...
            <div className="container w-full mx-auto">
                <div className="flex justify-between max-lg:flex-wrap max-lg:justify-center">
                    ...
                    <div className='lg:w-6/12 w-full max-lg:pt-10'>
                        ...
                        <h4 className='text-[#003459] font-normal text-2xl leading-[26.4px] pt-[38px] max-md:pt-5 max-lg:flex justify-center'>Benefits of Comparing Energy Plans</h4>
                        <div className='max-lg:w-[393px] max-lg:flex justify-center'>
